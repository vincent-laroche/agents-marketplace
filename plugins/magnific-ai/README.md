...
- One `magnific-ai` skill covering OAuth MCP setup, projects, custom agents, durable verified uploads, image, video, audio, stock asset, webhook, creation, and analytics workflows.
- A searchable snapshot of `https://docs.magnific.com/llms-full.txt`.
- A generated endpoint index.
- A dry-run-first JSON API helper using `MAGNIFIC_API_KEY`.
- A read-only project/manifest upload verifier using Magnific MCP OAuth.
- A constant-time webhook verifier using `MAGNIFIC_WEBHOOK_SIGNING_SECRET`.
